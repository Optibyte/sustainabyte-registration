  ...
  (
    ...
    return (
      <button
        ...
        className={cn(
          "group relative z-0 flex cursor-pointer items-center justify-center overflow-hidden rounded-lg px-4 py-3 whitespace-nowrap text-white [background:var(--bg)]",
